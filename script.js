function countDown() {
  const diasCasamento = new Date('6 July 2024 16:00:00');
...
function sugerirMusica(event) {
  if (input.value.length > 0 || sugerir.value.length > 0) {
    const link = `https://api.whatsapp.com/send/?phone=553284903006&text=Olá,+gostaria+de+sugerir+a+música+para+a+festa :+${
      input.value
